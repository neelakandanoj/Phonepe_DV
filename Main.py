...
def get_db_connection():
    if not hasattr(thread_local, "connection"):
        thread_local.connection = sq.connect("Phone_pay.db")
...
if selected == "Home":
    ...
    with col2:
        ...
        st.markdown("## :violet[Done by : ] Neelakandan OJ")
        st.markdown("[Inspired from](https://www.phonepe.com/pulse/)")
        st.markdown("[Githublink](https://github.com/neelakandanoj/Phone_pay_DV.git)")
